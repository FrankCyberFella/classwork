...
select '12/25/2025' - current_date as day_until_Christmas
;
-- be aware of result when calculating days between dates() - date() 
select  date('12/31/2025') - date('12/01/2025') as days_in_December
;
...
select date('10/30/2025') + interval '1 day' as month_w_31_days
      ,date('11/30/2025') + interval '1 day' as month_w_30_days
;
-- SQL date atrithmetic knows about leap years
select date('02/27/2025') + interval '2 days' as non_leap_year
     , date('02/27/2024') + interval '2 days' as leap_year
;
