...
{
    /***********************************************************************
     * GamblerDao - Data Access Object for Gambler data
     *
     * This class is used to access the Gambler data source
     * It contains methods to return all Gamblers, find a specific Gambler,
     * and find a Gambler by name.
     ***********************************************************************/
// Data Source
