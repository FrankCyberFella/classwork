...
--
-- This code assumes usage of the vegasdb database, country table
--
...
limit 5      -- Limit result to first 5 rows (postgres only - all data base managers have this,
             --                                                with different implement)
;